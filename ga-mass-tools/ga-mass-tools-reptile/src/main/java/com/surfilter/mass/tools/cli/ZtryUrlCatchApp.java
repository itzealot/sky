 ...
 *
 */
public class ZtryUrlCatchApp {

	static final Logger LOG = LoggerFactory.getLogger(ZtryUrlCatchApp.class);
	 ...
	 * @param month
	 */
	private static void fetchUrl(ZtryConfig config, String urlsDst, int year, int month) {
	...
	public static void fetchUrl(Map<String, String> cookie, String url, String urlsFile) {
		...
		ZtryCatchUtil.fetchUrl(url, new File(urlsFile), 0, info, false);
	}
}
