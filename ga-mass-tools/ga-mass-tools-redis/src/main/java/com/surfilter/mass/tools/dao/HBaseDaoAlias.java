...
public class HBaseDaoAlias {
	 ...
	 * @throws IOException
	 */
	public void insertDatas(Connection conn, String tableName, List<Put> puts) throws IOException {
	...
	public boolean[] exists(Connection conn, String tableName, List<Get> gets) {
		if (conn != null) {
			Table table = null;
	 ...
	 * @return
	 */
	public Result[] gets(Connection conn, String tableName, List<Get> gets) {
		if (conn != null) {
			Table table = null;
