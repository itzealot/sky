...
public class LineJoinCli implements CliRunner {
	...
	private static final String SRC_DIR = "sd"; // src dir
	private static final String DST_DIR = "dd"; // dst dir
	private static final String LINE_COUNTS = "lc"; // every line counts
