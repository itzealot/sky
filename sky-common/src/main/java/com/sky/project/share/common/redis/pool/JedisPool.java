...
public abstract class JedisPool extends Pool<Jedis> {
	...
	/**
	 * Create a JedisPoolConfig with new maxPoolSize becasuse JedisPoolConfig's
	 * default maxPoolSize is only 8. Also reset the idle checking time to 10
	 * minutes, the default value is half minute. Also rest the max idle to
	 * zero, the default value is 8 too. The default idle time is 60 seconds.
	 */
