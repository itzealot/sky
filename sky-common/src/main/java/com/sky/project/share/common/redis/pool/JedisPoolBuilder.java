...
/**
 * Build JedisPool smartly。 Depends on masterName whether prefix with "direct:",
 * it will build JedisSentinelPool or JedisDirectPool.
 */
public class JedisPoolBuilder {
	...
	private JedisPool buildSentinelPool(String sentinelMasterName, ConnectionInfo connectionInfo,
